...
base_character_unit::base_character_unit(
   ...
   magic_item_budget_(std::move(mi_budget)), faction_item_budget_(std::move(fi_budget)),
   total_item_budget_(std::move(ti_budget)), is_unique(is_unique), mount_name_(mount_name) {}
...
const budget& base_character_unit::magic_item_budget() const noexcept { return magic_item_budget_; }
const budget& base_character_unit::faction_item_budget() const noexcept { return faction_item_budget_; }
const budget& base_character_unit::total_item_budget() const noexcept { return total_item_budget_; }
