...
std::tuple<ItemClass, std::string, double> mage_character_unit::ranged_weapon() const {
...
> mage_character_unit::armour() const noexcept {
    return armours_;
}
...
std::unordered_map<
    std::string,
    double
> mage_character_unit::extras() const noexcept {
    return extras_;
}
...
void mage_character_unit::pick_weapon(ItemClass item_type, std::string name) {
    switch (item_type) {
...
void mage_character_unit::pick_armour(ItemClass item_type, std::string name) {
    switch (item_type) {
    case ItemClass::MUNDANE:
    {
...
void mage_character_unit::pick_extra(std::string name) {
